package com.example.bai2.ui.notification
    ...
    override suspend fun doWork(): Result {
        return try {
            ...
            for (appointment in appointments) {
                val appointmentTime = appointment.getFromTimeAsLocalDateTime()
                val minutesUntilAppointment = ChronoUnit.MINUTES.between(now, appointmentTime)
